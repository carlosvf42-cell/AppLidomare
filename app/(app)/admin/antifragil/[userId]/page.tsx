...
function DatoPersonal({ label, value }: { label: string; value: string }) {
  return (
    <div>
      <p className="text-[9px] tracking-[0.18em] uppercase mb-0.5" style={{ color: "rgba(255,255,255,0.35)", fontFamily: "var(--font-ui)" }}>
        {label}
      </p>
      <p className="text-sm" style={{ color: "rgba(255,255,255,0.9)", fontFamily: "var(--font-ui)", letterSpacing: "0.02em" }}>
        {value}
      </p>
    </div>
  );
    ...
    return (
      <div className="min-h-screen" style={{ background: "#080808" }}>
        <div className="px-5 pt-14 pb-6 flex items-center gap-3">
          ...
          <h1 className="text-lg font-light" style={{ color: "rgba(255,255,255,0.9)", fontFamily: "var(--font-ui)" }}>Cliente</h1>
        </div>
        <p className="text-xs text-center py-8" style={{ color: "#ff8080", fontFamily: "var(--font-ui)" }}>{error ?? "No se pudo cargar"}</p>
      </div>
    );
  }
    ...
    <div className="min-h-screen" style={{ background: "#080808" }}>
      ...
      <div className="px-5 pt-14 pb-6 flex items-center gap-3">
        ...
        <div className="min-w-0">
          ...
          <p className="truncate mt-1" style={{ fontSize: 11, color: "rgba(255,255,255,0.35)", fontFamily: "var(--font-ui)" }}>
            {data.user.email}
          </p>
        </div>
      </div>
        ...
        <section>
          ...
          {rutinaLoading ? (
            ...
            <div className="rounded-2xl px-5 py-5 space-y-3" style={GLASS}>
              <div>
                <p className="text-[10px] tracking-[0.18em] uppercase mb-1" style={{ color: "rgba(255,255,255,0.35)", fontFamily: "var(--font-ui)" }}>
                  Rutina activa
                </p>
                <p
                  className="truncate"
            ...
            <div className="rounded-2xl px-5 py-6 text-center space-y-3" style={GLASS}>
              <p style={{ fontSize: 13, color: "rgba(255,255,255,0.45)", fontFamily: "var(--font-ui)", lineHeight: 1.5 }}>
              ...
              <div className="mt-3 rounded-2xl px-4 py-4 space-y-3" style={GLASS}>
                <div className="flex items-center justify-between gap-2">
                  ...
                  <span
                    ...
                    style={{ background: m.bg, border: `0.5px solid ${m.border}`, color: m.color, fontFamily: "var(--font-ui)" }}
                  >
                    {m.label}
                  </span>
                </div>
                ...
                {analisis.mensaje_usuario && (
                  <div className="rounded-xl px-3 py-2.5" style={{ background: "rgba(42,191,191,0.06)", border: "0.5px solid rgba(42,191,191,0.25)" }}>
                    ...
                    <p className="text-xs" style={{ color: "rgba(255,255,255,0.95)", fontFamily: "var(--font-ui)", lineHeight: 1.5, letterSpacing: "0.02em" }}>
                      {analisis.mensaje_usuario}
                    </p>
                  </div>
                )}
        ...
        <section>
          ...
          {siguientesOpen && (data.entrenos.length === 0 ? (
            <div className="mt-3 rounded-2xl px-5 py-8 text-center" style={GLASS}>
              ...
              <p style={{ fontSize: 11, color: "rgba(255,255,255,0.25)", fontFamily: "var(--font-ui)", marginTop: 6, letterSpacing: "0.02em" }}>
                ...
                return (
                  <div key={e.id} className="rounded-2xl px-4 py-4 flex items-center justify-between gap-3" style={GLASS}>
                    <div className="min-w-0 flex-1">
                      ...
                      <p
                        className="truncate"
                        style={{ fontSize: 14, color: "rgba(255,255,255,0.85)", fontFamily: "var(--font-ui)", letterSpacing: "0.02em" }}
                      >
                        {e.nombre || "Sin nombre"}
                      </p>
                    </div>
