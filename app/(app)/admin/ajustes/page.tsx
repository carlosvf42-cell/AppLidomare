  ...
  return (
    <div className="min-h-screen" style={{ background: "#080808" }}>
      ...
      <div className="px-4 pb-16 space-y-6">
        ...
        >
          <span className="text-xs tracking-[0.15em] uppercase" style={{ color: "#2abfbf", fontFamily: "var(--font-serif)" }}>
            Panel de usuario
          </span>
        ...
        <section>
          ...
          <div className="rounded-2xl px-5 py-5 space-y-4" style={GLASS}>
            <div>
              <p className="text-[10px] tracking-wider uppercase mb-1" style={{ color: "rgba(255,255,255,0.35)", fontFamily: "var(--font-serif)" }}>
                Nombre
              </p>
              <p className="text-base" style={{ color: "rgba(255,255,255,0.95)", fontFamily: "var(--font-serif)", fontWeight: 300 }}>
                {displayName}
              </p>
            </div>
            <div>
              ...
              <p className="text-sm" style={{ color: "rgba(255,255,255,0.75)", fontFamily: "var(--font-serif)", letterSpacing: "0.02em" }}>
                {email}
              </p>
            </div>
            <div>
        ...
        <section>
          ...
          <div className="rounded-2xl px-5 py-5 space-y-3" style={GLASS}>
            <div className="flex items-center gap-3">
              ...
              >
                <span style={{ fontSize: 12, color: "#2abfbf", fontFamily: "var(--font-serif)", fontWeight: 600 }}>
                  {displayName.charAt(0).toUpperCase()}
                </span>
              </div>
              <div className="flex-1 min-w-0">
                <p className="text-sm truncate" style={{ color: "rgba(255,255,255,0.9)", fontFamily: "var(--font-serif)", letterSpacing: "0.02em" }}>
                  {displayName}
                </p>
                <p className="text-[11px] truncate" style={{ color: "rgba(255,255,255,0.35)", fontFamily: "var(--font-serif)" }}>
                  Admin · Acceso total
                </p>
              </div>
            </div>
        ...
        <section>
          ...
          <div className="rounded-2xl px-5 py-4 flex items-center justify-between" style={GLASS}>
            <span style={{ fontSize: 12, color: "rgba(255,255,255,0.6)", fontFamily: "var(--font-serif)", letterSpacing: "0.02em" }}>
              Versión
            </span>
            <span style={{ fontSize: 12, color: "rgba(255,255,255,0.85)", fontFamily: "var(--font-serif)", letterSpacing: "0.05em" }}>
              {APP_VERSION}
            </span>
          </div>
        </section>
